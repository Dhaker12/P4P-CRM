...
export default function Success() {
  return (
    <>
      <PageMeta
        title="React.js Success Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Success Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
