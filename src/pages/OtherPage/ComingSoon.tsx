...
export default function ComingSoon() {
  ...
  return (
    <>
      <PageMeta
        title="React.js Coming Soon Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Coming Soon  Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
