...
export default function Carousel() {
  return (
    <>
      <PageMeta
        title="React.js Carousel Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Carousel Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
