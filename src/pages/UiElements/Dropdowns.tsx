...
export default function Dropdowns() {
  return (
    <div>
      <PageMeta
        title="React.js Dropdowns Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Dropdowns Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
