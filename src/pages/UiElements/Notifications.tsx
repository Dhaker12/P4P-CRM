...
export default function Notifications() {
  ...
  return (
    <>
      <PageMeta
        title="React.js  Notifications | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Notifications  page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
