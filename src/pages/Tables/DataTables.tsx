...
export default function DataTables() {
  return (
    <>
      <PageMeta
        title="React.js Data Tables Dashboard | Business 4 Passion - Next.js Admin Dashboard Template"
        description="This is React.js Data Tables Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
