...
export default function BasicTables() {
  return (
    <>
      <PageMeta
        title="React.js Basic Tables Dashboard | Business 4 Passion - Next.js Admin Dashboard Template"
        description="This is React.js Basic Tables Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
