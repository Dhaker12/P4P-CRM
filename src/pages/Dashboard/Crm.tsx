...
export default function Crm() {
  return (
    <>
      <PageMeta
        title="React.js CRM Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js CRM Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
