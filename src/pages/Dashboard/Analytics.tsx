...
export default function Analytics() {
  return (
    <>
      <PageMeta
        title="React.js Analytics Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Analytics Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
