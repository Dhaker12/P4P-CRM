...
export default function Stocks() {
  return (
    <>
      <PageMeta
        title="React.js Stocks Dashboard | Business 4 Passion - React.js Admin Dashboard Template"
        description="This is React.js Stocks Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
