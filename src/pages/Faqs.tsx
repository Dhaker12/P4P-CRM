...
export default function Faqs() {
  return (
    <>
      <PageMeta
        title="React.js Faqs Dashboard | Business 4 Passion - Next.js Admin Dashboard Template"
        description="This is React.js Faqs Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
