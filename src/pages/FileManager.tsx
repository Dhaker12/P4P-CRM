...
export default function FileManager() {
  return (
    <>
      <PageMeta
        title="React.js File Manager Dashboard | Business 4 Passion - Next.js Admin Dashboard Template"
        description="This is React.js File Manager Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
