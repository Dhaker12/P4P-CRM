...
export default function PricingTables() {
  return (
    <div>
      <PageMeta
        title="React.js Pricing Dashboard | Business 4 Passion - Next.js Admin Dashboard Template"
        description="This is React.js Pricing Dashboard page for Business 4 Passion - React.js Tailwind CSS Admin Dashboard Template"
      />
