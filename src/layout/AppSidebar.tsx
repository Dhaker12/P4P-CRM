...
const navItems: NavItem[] = [
  {
    ...
    name: "Dashboard",
    subItems: [
      { name: "P4P Dashboard", path: "/", pro: false, new: true },
  ...
  },
  {
    ...
    subItems: [
      { name: "Players List", path: "/p4p-admin/users/players", pro: false, new: true },
      { name: "Add Player", path: "/p4p-admin/users/players/add", pro: false, new: true },
      { name: "Players Analytics", path: "/p4p-admin/users/players/analytics", pro: false, new: true },
    ],
  },
  {
    icon: <BoxIcon />,
    ...
    subItems: [
      { name: "Clubs List", path: "/p4p-admin/clubs", pro: false, new: true },
      { name: "Add Club", path: "/p4p-admin/clubs/add", pro: false, new: true },
      { name: "Availability & Schedules", path: "/p4p-admin/clubs/schedules", pro: false, new: true },
      { name: "Clubs Analytics", path: "/p4p-admin/clubs/analytics", pro: false, new: true },
    ],
  },
  {
    icon: <BoxIcon />,
    name: "Marketplace",
    subItems: [
      { name: "Products", path: "/p4p-admin/marketplace/products", pro: false, new: true },
      { name: "Add Product", path: "/p4p-admin/marketplace/products/add", pro: false, new: true },
      { name: "Brands", path: "/p4p-admin/marketplace/brands", pro: false, new: true },
      { name: "Categories", path: "/p4p-admin/marketplace/categories", pro: false, new: true },
      { name: "Coupons", path: "/p4p-admin/marketplace/coupons", pro: false, new: true },
      { name: "Marketplace Analytics", path: "/p4p-admin/marketplace/analytics", pro: false, new: true },
    ],
  },
  {
    icon: <CalenderIcon />,
